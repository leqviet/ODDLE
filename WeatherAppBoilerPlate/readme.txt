Prepare for running project:
	...
	2/ Run sql query in file sql/database.sql.
...
Maybe you need run maven command "mvn clean install -DskipTests=true" before do step 2.
...
Go to location "/WeatherAppBoilerPlate" to run command:
	1/ Do maven "mvn clean install -DskipTests=true".
